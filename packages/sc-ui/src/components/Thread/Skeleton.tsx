...
/**
 * > API documentation for the Community-UI Thread Skeleton component. Learn about the available props and the CSS API.

 #### Import

 ```jsx
 import {ThreadSkeleton} from '@selfcommunity/ui';
 ```
