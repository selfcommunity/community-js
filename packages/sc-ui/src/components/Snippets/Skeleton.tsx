...
/**
 * > API documentation for the Community-UI Snippets Skeleton component. Learn about the available props and the CSS API.

 #### Import

 ```jsx
 import {SnippetsSkeleton} from '@selfcommunity/ui';
 ```
