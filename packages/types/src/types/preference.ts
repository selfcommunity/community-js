...
export enum SCPreferenceName {
  ...
  KEYCLOAK_SIGNIN_ENABLED = 'keycloak_signin_enabled',
  KEYCLOAK_APP_KEY = 'keycloak_app_key',
  KEYCLOAK_APP_SECRET = 'keycloak_app_secret',
  KEYCLOAK_APP_ISSUER = 'keycloak_app_issuer',
  ENTRAID_SIGNIN_ENABLED = 'entraid_signin_enabled',
  ENTRAID_APP_KEY = 'entraid_app_key',
  ENTRAID_APP_SECRET = 'entraid_app_secret',
  ENTRAID_APP_ISSUER = 'entraid_app_issuer',
  ENTRAID_APP_TENANT_ID = 'entraid_app_tenant_id',
