...
export const CONFIGURATIONS_CUSTOM_NAVBAR_ITEM_ENABLED = `${SCPreferenceSection.CONFIGURATIONS}.${SCPreferenceName.CUSTOM_NAVBAR_ITEM_ENABLED}`;
export const CONFIGURATIONS_CUSTOM_NAVBAR_ITEM_TEXT = `${SCPreferenceSection.CONFIGURATIONS}.${SCPreferenceName.CUSTOM_NAVBAR_ITEM_TEXT}`;
export const CONFIGURATIONS_CUSTOM_NAVBAR_ITEM_URL = `${SCPreferenceSection.CONFIGURATIONS}.${SCPreferenceName.CUSTOM_NAVBAR_ITEM_URL}`;
export const CONFIGURATIONS_CUSTOM_NAVBAR_ITEM_IMAGE = `${SCPreferenceSection.CONFIGURATIONS}.${SCPreferenceName.CUSTOM_NAVBAR_ITEM_IMAGE}`;
/**
 * PROVIDERS
 */
...
export const DATA_TYPES = {
  ...
  [CONFIGURATIONS_CUSTOM_NAVBAR_ITEM_ENABLED]: stringType,
