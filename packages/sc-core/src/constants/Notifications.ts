...
export const DEFAULT_NOTIFICATIONS: SCNotificationsType = {
  [NOTIFICATIONS_WEB_SOCKET_OPTION]: {[NOTIFICATIONS_DISABLE_TOAST_MESSAGE_OPTION]: false},
  [NOTIFICATIONS_WEB_PUSH_MESSAGING_OPTION]: {[NOTIFICATIONS_DISABLE_TOAST_MESSAGE_OPTION]: false},
};
