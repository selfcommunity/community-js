...
/**
 * > API documentation for the Community-UI User Feed Skeleton Template. Learn about the available props and the CSS API.

 #### Import

 ```jsx
 import {UserFeedSkeleton} from '@selfcommunity/templates';
 ```
