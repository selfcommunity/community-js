    ...
    <Root className={classes.root} {...rest}>
      <CardContent className={classes.content}>
        <Button
          ...
          <Avatar variant="rounded" src={scEvent.managed_by.avatar} alt={scEvent.managed_by.username} className={classes.avatar}></Avatar>
          <Typography variant="h3">{intl.formatMessage(messages.title, { user: scEvent.managed_by.username })}</Typography>
        </Button>
