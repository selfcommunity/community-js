          ...
          <>
            <Button
              ...
              <Typography component="span" className={classes.paperContrastColor}>
                {intl.formatMessage(messages.shares, {
                  total: sharesCount
                })}
              </Typography>
            </Button>
            ...
            {Boolean(anchorEl) && (
              <>
                {!isMobile ? (
                  ...
                  <SwipeableDrawer open onClick={handleClose} onClose={handleClose} onOpen={handleOpenShareMenu} anchor="bottom" disableSwipeToOpen>
                    {renderShareMenuItems()}
                  </SwipeableDrawer>
                )}
              </>
