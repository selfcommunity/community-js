...
export interface UserPaymentMethodsPortalProps {
  /**
 ...
 * @param inProps
 */
export default function UserPaymentMethodsPortal(inProps: UserPaymentMethodsPortalProps): JSX.Element {
  // PROPS
  const props: UserPaymentMethodsPortalProps = useThemeProps({
    props: inProps,
    name: PREFIX
  });
