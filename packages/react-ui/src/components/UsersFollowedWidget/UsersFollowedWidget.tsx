...
const PREFIX = 'SCUsersFollowedWidget';
...
export interface UsersFollowedWidgetProps extends VirtualScrollerItemProps {
  /**
   * The user id
   * @default null
   */
...
/**
 * > API documentation for the Community-JS Users Followed Widget component. Learn about the available props and the CSS API.

 #### Import

 ```jsx
 import {UsersFollowedWidget} from '@selfcommunity/react-ui';
 ```

 #### Component Name

 The name `SCUsersFollowedWidget` can be used when providing style overrides in the theme.
 ...
 |---|---|---|
 |root|.SCUsersFollowedWidget-root|Styles applied to the root element.|
 |title|.SCUsersFollowedWidget-title|Styles applied to the title element.|
 |noResults|.SCUsersFollowedWidget-no-results|Styles applied to no results section.|
 |followedItem|.SCUsersFollowedWidget-followed-item|Styles applied to the followed item element.|
 |showMore|.SCUsersFollowedWidget-show-more|Styles applied to show more button element.|

 * @param inProps
 */
export default function UsersFollowedWidget(inProps: UsersFollowedWidgetProps): JSX.Element {
  // CONST
  const limit = 3;
  ...
  // PROPS
  const props: UsersFollowedWidgetProps = useThemeProps({
    props: inProps,
    name: PREFIX
  });
