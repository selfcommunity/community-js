...
export default function NotificationMenu(inProps: NotificationsMenuProps) {
  ...
  const {slotProps = {paper: {className: classes.paper}, list: {component: Box}}, SnippetNotificationsProps = {}, ...rest} = props;

  // HOOKS
  const scRoutingContext: SCRoutingContextType = useSCRouting();

  return (
    <Root className={classes.root} slotProps={slotProps} {...rest}>
