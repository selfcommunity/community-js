...
import {CategoriesPopularWidget, CategoriesSuggestionWidget, FeedUpdatesWidget, SCFeedWidgetType, UserSuggestionWidget} from '../../index';
...
const template = (args: any) => {
  ...
  return (
    <div style={{width: '100%', marginTop: 30}}>
      <Button color="info" variant="contained" size="small" style={{position: 'absolute', top: 19, left: 25}} onClick={handleRefresh}>
        Refresh
      </Button>
...
export const ScheduledFeed: StoryObj<FeedProps> = {
  args: {
    id: 'scheduled',
    endpoint: {
      ...Endpoints.GetScheduledFeedObjects,
      url: () => Endpoints.GetScheduledFeedObjects.url({type: SCContributionType.POST})
    },
    widgets: [],
    ItemComponent: FeedObject,
