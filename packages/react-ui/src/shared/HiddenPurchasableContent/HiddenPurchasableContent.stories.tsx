...
import HiddenPurchasableContent, { HiddenPurchasableContentProps } from './index';
...
const template = (args: HiddenPurchasableContentProps) => <HiddenPurchasableContent {...args} />;
